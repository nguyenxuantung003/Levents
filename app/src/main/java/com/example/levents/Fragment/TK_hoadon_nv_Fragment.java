...
public class TK_hoadon_nv_Fragment extends Fragment {
com.example.levents.databinding.FragmentQLhoadonBinding binding;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        SharedPreferences preferences = getActivity().getSharedPreferences("NHANVIEN", Context.MODE_PRIVATE);
        //int manv = preferences.getString("manhanvien", "");
        int manv = preferences.getInt("manhanvien",0);
        donhangDao = new Donhang_DAO(getContext());
        LinearLayoutManager layoutManager = new LinearLayoutManager(getContext());
        binding.rcvHoadon.setLayoutManager(layoutManager);
        list = donhangDao.getDsDonHangTheoNhanVien(manv);
