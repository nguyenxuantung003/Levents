...
import com.example.levents.databinding.ActivityUpdatethongtinBinding;

import java.util.ArrayList;

public class Updatethongtin_Activity extends AppCompatActivity {
    ActivityUpdatethongtinBinding biding;
    Khachang_DAO dao;
    Khachhang nguoiDung;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        biding = ActivityUpdatethongtinBinding.inflate(getLayoutInflater());
        setContentView(biding.getRoot());
        SharedPreferences preferences = getSharedPreferences("KHACHHANG", MODE_PRIVATE);
        int maTK = preferences.getInt("makhachhang",0);
        ...
        biding.imgTroVeDangNhap.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(Updatethongtin_Activity.this,ProfileActivity.class));
            }
        });
            ...
            public void onClick(View view) {
                ...
                if (biding.edtTenDangNhapDangKy.getError() == null &&
                    ...
                    if (matkhaucu1.equals(matkhau)) {
                        ...
                        nguoiDung.setAnhkhachhang(urlAnh);
                        nguoiDung.setSodienthoai(sodienthoai1);
                        boolean result = dao.updatekhachhang(nguoiDung);
                        if (result) {
                            list.clear();
                            list = dao.getAllNguoiDung();
                            Intent intent = new Intent(Updatethongtin_Activity.this, Login_Activity.class);
                            startActivity(intent);
                            Toast.makeText(Updatethongtin_Activity.this, "Đổi thông tin thành công", Toast.LENGTH_SHORT).show();
                        } else {
                            // Đăng ký thất bại
                            Toast.makeText(Updatethongtin_Activity.this, "Đăng ký thất bại", Toast.LENGTH_SHORT).show();
                        }
                    } else {
